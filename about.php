...
<body>
        ...
        <div class="container">
            <div class="about-content">
                <div class="about-image">
                    <img src="2.png" alt="Proma Africa Team" class="about-img">
                </div>
    ...
    <section class="mission-vision">
        <div class="container">
            ...
            <div class="vision">
                <h3>Our Vision</h3>
                <p>To be a leading force in transforming valuation, land administration, real estate, and resettlement through innovative technology and expert consultancy—driving efficiency, transparency, and sustainability for all stakeholders.</p>
            </div>
        </div>
    </section>
